  ...
  return (
    <div className="container">
            <header>
              <div className="container">
                <div id="branding">
                  <h1><span class="highlight">East Bay Moving</span></h1>
                </div>
                <nav>
                  <u1>
      ...
      <section id="showcase">
        <div className="container">
          <h1>Somewhat Affordable & Professional Movers</h1>
      ...
      <footer>
        <p>East Bay Moving, Copyright &copy; 2024</p>
      </footer>
    </div>
  );
};
